...
pencere.title('Flappy Bird-Gevsek Kus')
...
borular=[]
pencere.listen()
pencere.onscreenclick(bird_up)#fareyle ekrana tıkladığımız zmn bu fonks çağrılıcak
...
while devam:
    ...
    if(time.time()-starting_time>random.randint(5,15)):#5 saniyeden sonra starting yapıcak,yeni boru üretecek
        starting_time=time.time()
